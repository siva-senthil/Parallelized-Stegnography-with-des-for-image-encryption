...
class Steganography:
    ...
    def __merge_rgb(rgb1, rgb2):
        r1, g1, b1 = rgb1
        r2, g2, b2 = rgb2
        rgb = (r1[:4] + r2[:4], g1[:4] + r2[:4], b1[:4] + b2[:4])
        return rgb
...
def main():
    ...
    if choice == 1:
        ...
        for i in range(10):
            ...
            mapp.append(int(encode_time))

        plt.xlabel('Number of images')
        plt.ylabel('Encoding Time (seconds)')
        plt.title(f"Total encoding time for 10 images: {total_encode_time:.2f} seconds")
        ...
        for i in range(10):
            ...
            mapp.append(int(decode_time))

        plt.xlabel('Number of images')
        plt.ylabel('Decoding Time (seconds)')
        plt.title(f"Total decoding time for 10 images: {total_decode_time:.2f} seconds")
        plt.scatter(range(1, 11), mapp)
        plt.show()
